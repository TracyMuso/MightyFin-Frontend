        ...
        <div className="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
          <div className="inline-block min-w-full shadow rounded-lg overflow-hidden">
            <table className="min-w-full leading-normal">
              <thead>
                <tr>
                  <th className="px-5 py-3 border-b-2 border-purple-200 text-left font-bold text-purple-300 uppercase tracking-wider">
                    DATE
                  </th>
                  <th className="px-5 py-3 border-b-2 border-purple-200  text-left font-bold text-purple-300 uppercase tracking-wider">
                    TXN ID
              ...
              <tbody>
                <tr>
                  ...
                  <td className="px-5 py-5 bg-white text-sm">
                    <p className="text-gray-900 whitespace-no-wrap">k12,000</p>
                  </td>
                  <td className="px-5 py-5 bg-white text-sm">
            ...
            <div className="px-5 py-5 bg-white border-t border-purple-200 flex items-center justify-between">
              ...
              <div className="inline-flex mt-2 xs:mt-0">
                <button className="px-6 py-3 text-center bg-white border hover:bg-yellow-300 rounded-md text-black">
                  Prev
                </button>
                <button className="px-6 py-3 text-center bg-purple-500 hover:bg-purple-primary rounded-md text-white">
                  Next
                </button>
              </div>
              <div>
                <span className="text-sm">Showing 4 out of 50 items</span>
              </div>
            </div>
          </div>
        </div>
